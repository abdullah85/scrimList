...
Once installed open any Course, Path or Topic examples such as:

* Course - [Learn Javascript](https://scrimba.com/learn-javascript-c0v)
* Path - [Full Stack Developer Path](https://scrimba.com/fullstack-path-c0fullstack)
* Topic - [Learn AI Agents](https://scrimba.com/learn-ai-agents-c034)

Clicking on the icon will toggle the active status of the extension.
...
Ensure the ScrimList Icon is disabled, the icon displays <img src="media/icon_off.png" width="35px" height="35px" align="top" alt="ScrimList icon does not contain any text when disabled."> and then refresh the page.
