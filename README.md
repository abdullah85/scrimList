...
![Enabled Example](media/ScrimbaFullStack-a1.png)

In case, they do not appear, try reloading the page.

## Disable Number Prefixes

To disable numbering, first ensure the ScrimList Icon is disabled, displays <img src="media/icon_off.png" width="35px" height="35px" align="top" alt="ScrimList icon does not contain any text when disabled."> and then refresh the page.

![Disabled Example](media/ScrimbaFullStack-a3.png)
...
![Numbered Example](media/ScrimbaFullStack-a2.png)

The copy element is also enabled when the extension is not activated as shown below.

![Plain Example](media/ScrimbaFullStack-a4.png)
